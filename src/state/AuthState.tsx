...
export function AuthStateProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo<AuthStateValue>(() => ({
    ...
    verifyEmailOtp,
    signOut,
  }), [ready, session, verification, verificationBusy, verificationMessage, verifyOnWebsite, finishWebsiteVerification, signIn, signUp, startAnonymousDemo, sendEmailOtp, verifyEmailOtp, signOut]);
