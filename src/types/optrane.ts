...
export type ResearchSeverity = 'critical' | 'high' | 'medium' | 'low' | string;
...
export interface IntegrationHealth {
  ...
  googleCloud?: { configured?: boolean; reachable?: boolean; backend?: string; model?: string };
  parallel?: { configured?: boolean; reachable?: boolean; status?: string; provider?: string };
  agentRuntime?: { configured?: boolean; reachable?: boolean; resource?: string; adk?: boolean; backend?: string; model?: string };
